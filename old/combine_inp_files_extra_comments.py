...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="""Combine .inp files. Accepts glob
                        patterns for selecting files to be combined, or file names can
            be given as individual arguments.""")
